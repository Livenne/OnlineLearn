package com.livenne.onlinelearn.feature.auth;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NetworkUtils.loadResource("/auth/verify",
